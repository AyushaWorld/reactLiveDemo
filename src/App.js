      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography variant="h5" className={classes.littleSpace} color="primary">
           <p style={{color:"gray"}}>If you want to know me please click Contact Us</p>
        ...
        <div className={`${classes.grid} ${classes.bigSpace}`}>
          ...
          <Grid icon={<EventNoteIcon style={{fill: "#449A76", height:"125", width:"125"}}/>} title="Task" btnTitle="Show me More"/>
          <Grid icon={<TrendingUpIcon style={{fill: "#D05B2D", height:"125", width:"125"}}/>}  title="Performans" btnTitle="Show me More"/>
        </div>
        <div className={`${classes.grid} ${classes.littleSpace}`}>  
          <Grid icon={<ImportExportIcon style={{fill: "#5EA780", height:"125", width:"125"}}/>}  title="Data Transfer" btnTitle="Show me More"/>
